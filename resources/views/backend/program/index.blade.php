...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        @if (isset($data['page']))
                            <form action="{{ route('program_page.update', $data['page']->id) }}" method="POST"
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                {{-- <input type="text" name="description" value="{{ $data['page']->description ?? '' }}"
                                    class="form-control description" placeholder="Address"> --}}
                                <textarea class="form-control" name="description" id="editor" placeholder="">{{ $data['page']->description ?? '' }}</textarea>
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        <form action="{{ route($base_route . 'store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 banner">
                                <label for="formFile1" class="form-label">Banner</label>
                                <div class="form-group d-flex justify-content-between">

                                    <input name="banner" class="form-control file-input custom-file-input"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <textarea name="university" class="form-control university" rows="5" id="editor102"
                                        placeholder="Type university" style="height:120px;"></textarea>
                                </div>
                            </div>
    ...
    <div class="col-12">
                            ...
                            <tbody>
                                @foreach ($data['posts'] as $program)
                                    <tr data-index="0">
                                        ...
                                        <td><small>{!! Str::limit(strip_tags($program->description), 70) !!}</small></td>
                                        <td>
                                            @if (isset($program->image))
                                                <img src="{{ asset('storage/' . $program->image) }}" width="50"
                                                    class="img-float">
                                            @else
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input check-uncheck"
                                                    data-id="{{ $program->id }}" type="checkbox" role="switch"
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-around">
                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#viewPost-{{ $program->id }}">
                                                    <i class="bi bi-eye-fill fs-5 p-2 text-success"></i></a>
                                                {{-- <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#editPost-{{ $program->id }}">
                                                    <i class="bi bi-pencil-square fs-5 p-2"></i></a> --}}
                                                <a href="{{ route($base_route . 'edit', $program->id) }}"><i
                                                        class="bi bi-pencil-square fs-5 p-2"></i></a>

                                                <form action="{{ route($base_route . 'destroy', $program->id) }}"
        ...
        {{-- Post View  --}}
        @foreach ($data['posts'] as $program)
            <div class="modal fade" id="viewPost-{{ $program->id }}" tabindex="-1" aria-labelledby="viewPostLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-2">
                                    @isset($program->image)
                                        <img src="{{ asset('storage/' . $program->image) }}" class="img-thumbnail"
                                ...
                                <div class="col-sm-2">
                                    @isset($program->banner)
                                        <img src="{{ asset('storage/' . $program->banner) }}" class="img-thumbnail"
                                            width="60px" height="60px">
                                    @else
                                        <img src="{{ asset('no-image.png') }}" class="img-thumbnail" width="60px"
                                            height="60px">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-4 mt-2">
                                    <small>{{ $program->createdBy?->name ?? '' }}</small>
                                </div>
                                <label for="inputPassword" class="col-sm-2 col-form-label">Updated by</label>
                                <div class="col-sm-4 mt-2">
                                    <small>{{ $program->updatedBy?->name ?? 'Not Updated Yet' }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
