...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        @if (isset($data['page']))
                            <form action="{{ route('testimonial_page.update', $data['page']) }}" method="POST"
    ...
    <div class="col-12">
            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <table class="display" id="myTable">
                        ...
                        <tbody>
                            @foreach ($data['posts'] as $testimonial)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $testimonial->image) }}" class="img-thumbnail"
                                            width="50px;">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-check form-switch text-center mx-auto">
                                            <input class="form-check-input check-uncheck mx-auto"
                                                data-id="{{ $testimonial->id }}" type="checkbox" role="switch"
                                                id="flexSwitchCheckChecked"
                                                {{ $testimonial->status == '0' ? 'checked' : '' }}>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-around">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#viewPost-{{ $testimonial->id }}">
                                                <i class="bi bi-eye-fill fs-5 p-2 text-success"></i></a>
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#editPost-{{ $testimonial->id }}">
        ...
        {{-- Post View  --}}
        @foreach ($data['posts'] as $testimonial)
            <div class="modal fade" id="viewPost-{{ $testimonial->id }}" tabindex="-1" aria-labelledby="viewPostLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-4 mt-2">
                                    <small>{{ $testimonial->createdBy?->name ?? '' }}</small>
                                </div>
                                <label for="inputPassword" class="col-sm-2 col-form-label">Created by</label>
                                <div class="col-sm-4 mt-2">
                                    <small>{{ $testimonial->createdBy?->name ?? '' }}</small>
