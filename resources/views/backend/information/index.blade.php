...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        @if (isset($data['page']))
                            <form action="{{ route('information_page.update', $data['page']) }}" method="POST"
    ...
    <div class="col-12">
                ...
                <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                    ...
                    <div class="datatable-container">
                        <table class="table table-borderless datatable datatable-table">
                            ...
                            <tbody>
                                @foreach ($data['posts'] as $information)
                                    <tr data-index="0">
                                        <td> {{ $loop->iteration }} </td>
                                        <td>
                                            <small> {{ $information->title }} </small>
                                        </td>
                                        <td><small>{!! Str::limit(strip_tags($information->description), 70) !!}</small></td>
                                        <td>
                                            @if (isset($information->image))
                                                <img src="{{ asset('storage/' . $information->image) }}" width="50"
                                                    class="img-float">
                                            @else
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input check-uncheck"
                                                    data-id="{{ $information->id }}" type="checkbox" role="switch"
                                                    id="flexSwitchCheckChecked"
                                                    {{ $information->status == '0' ? 'checked' : '' }}>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-around">
                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#viewPost-{{ $information->id }}">
        ...
        {{-- Post View  --}}
        @foreach ($data['posts'] as $information)
            <div class="modal fade" id="viewPost-{{ $information->id }}" tabindex="-1" aria-labelledby="viewPostLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-2">
                                    @isset($information->image)
                                        <img src="{{ asset('storage/' . $information->image) }}" class="img-thumbnail"
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-4 mt-2">
                                    <small>{{ $information->createdBy?->name ?? '' }}</small>
                                </div>
                                <label for="inputPassword" class="col-sm-2 col-form-label">Created by</label>
                                <div class="col-sm-4 mt-2">
                                    <small>{{ $information->createdBy?->name ?? '' }}</small>
