...
@section('content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit {{ $data['kindergarten']->title }}</li>
    ...
    <div class="card pt-3">
        <div class="card-body">
            <form action="{{ route($base_route . 'update', $data['kindergarten']->id) }}" method="POST"
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="title" class="form-control title"
                            value="{{ $data['kindergarten']->title }}" id="floatingName" placeholder="Title Name">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" name="sub_title" class="form-control sub_title"
                            value="{{ $data['kindergarten']->sub_title }}" id="floatingName" placeholder="Subtitle Name">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 image">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <div class="image">
                            @if ($data['kindergarten']->image)
                                <img src="{{ asset('storage/' . $data['kindergarten']->image) }}" alt=""
                ...
                value="" id="floatingName" placeholder="Your Name"> --}}
                        <textarea name="description" class="form-control description" rows="5" id="editor100"
                            placeholder="Type Description" style="height:120px;"> {!! $data['kindergarten']->description !!} </textarea>
            ...
            <div class="row">
                <div class="col-md-12 d-flex align-content-start flex-wrap">
                    @forelse ($data['kindergarten']->images as $image)
                        <div class="image p-2">
