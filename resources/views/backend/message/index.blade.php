            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        @if (isset($data['page']))
                            <form action="{{ route('message_page.update', $data['page']) }}" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        <form action="{{ route($base_route . 'store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <textarea class="form-control" name="seo_description" placeholder="Seo Description" id="floatingTextarea"></textarea>
                                    <label for="floatingTextarea">Seo Description</label>
                                </div>
                            </div>
                            ...
                            <tbody>
                                @foreach ($data['posts'] as $message)
                                    <tr data-index="0">
                                        ...
                                        <td>
                                            <small>{!! Str::limit(strip_tags($message->description), 70) !!}</small>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input check-uncheck"
                                                    data-id="{{ $message->id }}" type="checkbox" role="switch"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-6">
                                    <small>{{ $message->designation }}</small>
                                </div>
                            </div>
                            <div class="mb-1 row">
