...
<section class="news-and-events__section section-padding">
    <div class="container">
                ...
                <div class="events__items">
                    <div class="row align-items-center">
                        <div class="col-md-9 ps-5">
                            ...
                            <a href="#" class="btn btn-hoverable" data-bs-toggle="modal" data-bs-target="#detailsModal-{{$news->id}}">
                                <span>View Details</span>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <div class="img__holder">
                                <img src="{{asset('storage/'.$news->image)}}" width="100%" height="100%" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="detailsModal-{{$news->id}}" tabindex="-1" aria-labelledby="detailsModalLabel"
            aria-hidden="true">
